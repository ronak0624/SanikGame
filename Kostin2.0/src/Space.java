...
public class Space extends JPanel implements ActionListener 
{
    ...
    public java.net.URL bobby = Main.class.getResource("/resources/bobby.png");
    public java.net.URL enemy = Main.class.getResource("/resources/enemy.gif.png");
    public java.net.URL link = Main.class.getResource("/resources/link.png");
    ...
    private void makeMap(){
    	...
    	map[2][1].addEnemy(200, 200, 2, 1, bobby);
    	map[2][2].addEnemy(200, 200, 1, 2, link);
    	map[2][3].addEnemy(300, 300, 2, 2, link);
    	map[2][4].addEnemy(200, 200, 3, 1, enemy);
    	map[2][4].addEnemy(200, 200, 1, 2, enemy);
    	map[3][1].addEnemy(300, 300, 2, 2, bobby);
    	map[3][2].addEnemy(200, 200, 3, 1, link);
    	map[3][3].addEnemy(200, 200, 1, 2, bobby);
    	map[3][4].addEnemy(300, 300, 2, 2, bobby);
    	map[3][4].addEnemy(200, 200, 3, 1, link);
    	map[4][1].addEnemy(200, 200, 1, 2, enemy);
    	map[4][2].addEnemy(300, 300, 2, 2, bobby);
    	map[4][3].addEnemy(200, 200, 3, 1, link);
    	map[4][4].addEnemy(200, 200, 1, 2, enemy);
    	map[4][4].addEnemy(300, 300, 2, 2, link);
    ...
    private void doDrawing(Graphics g) {
        ...
        g.drawString("Sanik", Player.x, Player.y);
